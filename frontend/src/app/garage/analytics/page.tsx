...
const listingsData = [
  { id: 1, image: 'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?w=150&h=150&fit=crop', name: 'Tesla Model 3', dateListed: '2025-02-15', status: 'Live', impressions: 12500, views: 1250, ctr: 10.0 },
  { id: 2, image: 'https://images.unsplash.com/photo-1553440569-bcc63803a83d?w=150&h=150&fit=crop', name: 'Ford Mustang', dateListed: '2025-02-10', status: 'Live', impressions: 9800, views: 980, ctr: 10.0 },
  { id: 3, image: 'https://images.unsplash.com/photo-1555212697-194d092e3b8f?w=150&h=150&fit=crop', name: 'BMW X5', dateListed: '2025-02-05', status: 'Sold', impressions: 7600, views: 760, ctr: 10.0 },
  { id: 4, image: 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=150&h=150&fit=crop', name: 'Toyota Camry', dateListed: '2025-01-28', status: 'Live', impressions: 5400, views: 540, ctr: 10.0 },
  { id: 5, image: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=150&h=150&fit=crop', name: 'Honda Civic', dateListed: '2025-01-20', status: 'Live', impressions: 3200, views: 320, ctr: 10.0 },
  { id: 6, image: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=150&h=150&fit=crop', name: 'Audi Q7', dateListed: '2025-01-15', status: 'Sold', impressions: 2800, views: 280, ctr: 10.0 },
  { id: 7, image: 'https://images.unsplash.com/photo-1511919884226-fd3cad34687c?w=150&h=150&fit=crop', name: 'Mercedes C-Class', dateListed: '2025-01-10', status: 'Live', impressions: 4100, views: 410, ctr: 10.0 },
  { id: 8, image: 'https://images.unsplash.com/photo-1542362567-b07e54358753?w=150&h=150&fit=crop', name: 'Chevrolet Silverado', dateListed: '2025-01-05', status: 'Live', impressions: 3900, views: 390, ctr: 10.0 },
];
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900 mt-2">28.3K</p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900 mt-2">9.6K</p>
                  <p className="text-sm text-green-600 mt-1">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={impressionsVsViewsData}>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Showing <span className="font-medium">8</span> of <span className="font-medium">42</span> listings
              </div>
